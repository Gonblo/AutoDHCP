#06.10.2020 Adam, Bartlomiej
#!/bin/bash

apt-get install isc-dhcp-server

#Pytania o parametry serwera
...
#Tworzenie pliku konfiguracyjnego Interfejsow
...
echo "" >> /etc/network/interfaces
echo "# Druga sieciowka" >> /etc/network/interfaces
...
echo "Restartuje Networking prosze czekac"
